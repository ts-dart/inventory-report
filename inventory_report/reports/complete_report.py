...
class CompleteReport(SimpleReport):
    @staticmethod
    def generate(list):
        oldest_manufacturing = SimpleReport.oldest_manufacturing_date(list)
        closest_expiration = SimpleReport.closest_expiration_date(list)
        ...
        return(
            ...
            f"{CompleteReport.__stock_by_company(list)}"
        )

    def __stock_by_company(products_list):
        companyes, text = {}, ''
